...
<body>
	...
	<c:if test="${pageContext.request.userPrincipal.name != null}">
		...
		<ul class="nav nav-tabs" style="font-size: 10px;" role="tablist">
	        ...
	        <li role="presentation" class="active" ><a href="editProfile">Edycja</a></li>
	...
	<div class="container" style="min-height: 800px; background-color: white; padding-top: 70px;">
		...
		<div class="col-lg-5" style="height: 420px;">
			...
			<div class="col-lg-12" style=" text-align: center;">
				<div class="col-lg-9 col-lg-offset-1" style="height: 500px;">
					...
					<img src="${pageContext.request.contextPath}/resources/pictures/profileImages/${pageContext.request.userPrincipal.name}.jpg" width="300" height="300">
		...
		<div class="col-lg-7" style="height: 420px">
			<div class="row">
				...
				<div class="col-lg-6" style="padding-top: 30px;">
					<a href="writeToMe" class="btn btn-danger" style="width: 180px; font-size: 19px; color: white;">Napisz do mnie!</a>
				</div>
		...
		<div class="col-lg-7 col-lg-offset-5" style="min-height: 500px; padding-bottom: 100px;">
			...
			<div class="panel">
			    ...
			    <img src="${pageContext.request.contextPath}/resources/images/${userNanny.whoWannCareNanny}.png"> Opieka nad dziećmi<br>
			    <img src="${pageContext.request.contextPath}/resources/images/${userNanny.whoWannCareOld }.png"> Opieka nad starszymi<br>
			<br>
			<div class="panel">
