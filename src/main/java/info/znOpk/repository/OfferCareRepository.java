...
public interface OfferCareRepository extends JpaRepository<OfferCare, Long> {
    ...
    @Transactional
    @Modifying
    @Query("update OfferCare u set u.whoWannCareNanny = ?2, u.whoWannCareOld = ?3, u.otherActClean = ?4, u.otherActCook = ?5," +
    ...
    void setOfferCareById(String xd, String whoWannCareNanny, String whoWannCareOld, String otherActClean, String otherActCook,
